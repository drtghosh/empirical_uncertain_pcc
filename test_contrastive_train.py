...
def test_con():
    ...
    test_train_loader = get_dataloader('train', config)
    num_test = len(test_train_loader)
    ...
    test_train_loader = cycle(test_train_loader)

    # directory to save results
    save_dir = os.path.join(config.proj_dir,
                            "results_on_tr/ckpt-{}-n{}".format(config.ckpt, saved_test))
