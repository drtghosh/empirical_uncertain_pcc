...
# save_negative_complete_pcn_parallel('data/PCN', 'train', 'lamp', id_dict, False, True, 12)
# save_negative_complete_pcn_parallel('data/PCN', 'validation', 'lamp', id_dict, False, True, 12)
